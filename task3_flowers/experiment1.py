...
class ProtoNetLightning(pl.LightningModule):
    def __init__(self, embedding_model, learning_rate=0.001, weight_decay=0.01):
...
embedding_model = SimpleEmbeddingNet(embedding_size=hyperparams["embedding_size"])
...
model_logger = ModelLogger(
    model_name="simple_cnn_protonet",
    test_loader=None,
...
checkpoint_callback = ModelCheckpoint(
    ...
    filename='protonet-simplecnn-{epoch:02d}-{val_loss:.2f}',
    save_top_k=1,
    monitor='val_loss',
    mode='min'
)
